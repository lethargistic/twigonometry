...
public class ModModelProvider extends FabricModelProvider {
    ...
    public void generateBlockStateModels(BlockModelGenerators blockStateModelGenerator) {
        blockStateModelGenerator.createCrossBlock(ModBlocks.SIMPLE_EXAMPLE_SAPLING, BlockModelGenerators.TintState.TINTED);
    ...
    public void generateItemModels(ItemModelGenerators itemModelGenerator) {
        flatBlockItem(ModBlocks.SIMPLE_EXAMPLE_SAPLING, itemModelGenerator);
        flatBlockItem(ModBlocks.FANCY_EXAMPLE_SAPLING, itemModelGenerator);
    }
