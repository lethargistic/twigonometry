...
public class ModFoliagePlacerTypes {
    public static final FoliagePlacerType<ExampleFoliagePlacer> EXAMPLE_FOLIAGE_PLACER =
            register("example_foliage_placer", new FoliagePlacerType<>(ExampleFoliagePlacer.CODEC));
    ...
    public static void initialize() {
        ...
        Shared.SHARED_EXAMPLE_FOLIAGE_PLACER = EXAMPLE_FOLIAGE_PLACER;
    }
}