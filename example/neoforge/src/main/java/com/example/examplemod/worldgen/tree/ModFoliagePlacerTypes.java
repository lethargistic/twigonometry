...
public class ModFoliagePlacerTypes {
    ...
    public static final DeferredHolder<FoliagePlacerType<?>, FoliagePlacerType<ExampleFoliagePlacer>> EXAMPLE_FOLIAGE_PLACER =
            FOLIAGE_PLACER_TYPES.register("example_foliage_placer", () -> new FoliagePlacerType<>(ExampleFoliagePlacer.CODEC));
    ...
    static {
        Shared.SHARED_EXAMPLE_FOLIAGE_PLACER = EXAMPLE_FOLIAGE_PLACER.get();
    }
}